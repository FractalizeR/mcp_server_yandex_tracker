# Этап 1.2: get-issue-links → batch support

**Execution Type:** `parallel` (может выполняться одновременно с 1.1, 1.3)

**Цель:** Добавить поддержку массива `issueIds` в get-issue-links tool.
