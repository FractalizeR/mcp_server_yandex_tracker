...
Этап 2.1 успешно завершен. Все критерии готовности выполнены:
- ParsedCategoryFilter перемещен в @mcp-framework/core
- Удалены config.ts, constants.ts, config.test.ts
- Обновлены импорты в yandex-tracker
- Все пакеты собраны и провалидированы
- Документация обновлена
- Коммит: ba05a18 - refactor(infrastructure)!: удалить deprecated config и domain-specific код
