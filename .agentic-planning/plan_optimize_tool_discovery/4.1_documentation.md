...
- [x] Добавить секцию "Категоризация инструментов"
- [x] Документировать систему categories
- [x] Документировать систему priorities
- [x] Документировать naming convention для descriptions
- [x] Добавить таблицу существующих категорий
- [x] Добавить примеры для каждой категории
...
- [x] Добавить документацию `ToolMetadata` с новыми полями
- [x] Объяснить систему категоризации
- [x] Объяснить сортировку по priority
...
- [x] Проверить все ссылки работают
- [x] Проверить примеры кода корректны
- [x] Проверить таблицы отформатированы
- [x] Запустить `npm run validate:docs` (если есть)
