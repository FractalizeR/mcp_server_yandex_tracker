...
- [ ] `src/tools/README.md` обновлён (новое правило №5)
- [ ] `CLAUDE.md` обновлён (раздел про фильтрацию)
- [ ] Шаблон создания tool обновлён
- [ ] `validate:docs` проходит (лимиты не превышены)
- [ ] `MIGRATION.md` содержит breaking change notice (опционально)
