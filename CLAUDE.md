...
2. **Создай детальный план** в папке `.agentic-planning/plan_{краткое_описание_большой задачи}/`
   - Структура файлов в этой папке: `1.1_stage_title.md`, `1.2_stage_title.md`, `2.1_stage_title.md`
...
4. **После каждого этапа:**
   ...
   - ✅ Пуш в репозиторий
   - ✅ Предложить пользователю продолжить в новой сессии для экономии токенов и дать короткий промпт для этого.
