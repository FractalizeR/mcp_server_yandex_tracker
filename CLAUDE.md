...
- [ ] **Закоммитить изменения:** `git add -A && git commit -m "описание изменений"`
- [ ] **ВАЖНО:** Коммит-сообщения ТОЛЬКО на русском языке (включая тип, описание, breaking changes)
- [ ] Pre-commit hook автоматически отформатирует staged файлы
- [ ] Если коммит прошёл — изменения сохранены, форматирование применено
- [ ] Если hook упал — проверить ошибки ESLint, исправить, повторить коммит
