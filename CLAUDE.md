...
2. **Создай детальный план** в папке `.agentic-planning/plan_{краткое_описание_большой задачи}/`
...
4. **После каждого этапа:**
   ...
   - ✅ Коммит с описанием этапа на русском языке (если ты находишься в ветке `main` или `master` - спроси у пользователя разрешение)
   - ✅ Пуш в репозиторий
   - ✅ Предложить пользователю продолжить в новой сессии для экономии токенов, дать короткий промпт с указанием названия плана и шага плана для этого. Коротко описать, какие шаги можно дальше выполнять параллельно или только последовательно.
