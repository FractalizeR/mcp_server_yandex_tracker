...
import { GetIssueChangelogDefinition } from '@mcp/tools/api/issues/changelog/get-issue-changelog.definition.js';
import { GetIssueChangelogParamsSchema } from '@mcp/tools/api/issues/changelog/get-issue-changelog.schema.js';
 ...
 */
export class GetIssueChangelogTool extends BaseTool {
  /**
