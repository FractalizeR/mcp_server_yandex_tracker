...
import { GetIssueTransitionsDefinition } from '@mcp/tools/api/issues/transitions/get/get-issue-transitions.definition.js';
import { GetIssueTransitionsParamsSchema } from '@mcp/tools/api/issues/transitions/get/get-issue-transitions.schema.js';
 ...
 */
export class GetIssueTransitionsTool extends BaseTool {
  /**
