...
import { TransitionIssueDefinition } from '@mcp/tools/api/issues/transitions/execute/transition-issue.definition.js';
import { TransitionIssueParamsSchema } from '@mcp/tools/api/issues/transitions/execute/transition-issue.schema.js';
 ...
 */
export class TransitionIssueTool extends BaseTool {
  /**
