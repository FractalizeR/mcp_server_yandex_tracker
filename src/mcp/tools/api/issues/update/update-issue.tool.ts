...
import { UpdateIssueDefinition } from '@mcp/tools/api/issues/update/update-issue.definition.js';
import { UpdateIssueParamsSchema } from '@mcp/tools/api/issues/update/update-issue.schema.js';
