...
export const TOOL_SEARCH_INDEX: readonly StaticToolIndex[] = [
  ...
  {
    name: 'fyt_mcp_create_issue',
    category: ToolCategory.ISSUES,
    tags: ['issue', 'create', 'write'],
    isHelper: false,
    nameTokens: ['fyt', 'mcp', 'create', 'issue'],
    descriptionTokens: [],
    descriptionShort: 'Создать новую задачу в Яндекс',
  },
  {
  ...
  },
  {
    ...
    isHelper: false,
    nameTokens: ['fyt', 'mcp', 'update', 'issue'],
    descriptionTokens: [],
    descriptionShort: 'Обновить существующую задачу в Яндекс',
  },
  {
    name: 'fyt_mcp_get_issue_changelog',
    category: ToolCategory.ISSUES,
    tags: ['issue', 'changelog', 'history', 'read'],
    isHelper: false,
    nameTokens: ['fyt', 'mcp', 'get', 'issue', 'changelog'],
    descriptionTokens: [],
    descriptionShort: 'Получить историю изменений задачи',
  },
  {
    name: 'fyt_mcp_get_issue_transitions',
    category: ToolCategory.ISSUES,
    tags: ['issue', 'transitions', 'workflow', 'read'],
    isHelper: false,
    nameTokens: ['fyt', 'mcp', 'get', 'issue', 'transitions'],
    descriptionTokens: [],
    descriptionShort: 'Получить доступные переходы статусов задачи',
  },
  {
    name: 'fyt_mcp_transition_issue',
    category: ToolCategory.ISSUES,
    tags: ['issue', 'transition', 'workflow', 'write'],
    isHelper: false,
    nameTokens: ['fyt', 'mcp', 'transition', 'issue'],
    descriptionTokens: [],
    descriptionShort: 'Выполнить переход задачи в другой статус',
  },
  {
  ...
  },
  {
    ...
    isHelper: true,
    nameTokens: ['fyt', 'mcp', 'search', 'tools'],
